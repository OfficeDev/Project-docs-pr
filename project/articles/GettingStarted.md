...
|:------|:------|:------|:------|
| Project Hosted| <ul><li>JSOM (JavaScript Object Model)</li><li>REST</li></ul>|<ul><li> Browser</li></ul>| <ul><li> Timecard entry</li><li>Timecard approval</li><li>Project Status</li><li>Issues Report</li></ul> |
