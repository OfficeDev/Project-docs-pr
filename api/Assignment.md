...
|:-----|:-----:|:-----:|:-----:|:-----|:-----|
|ActualCostWorkPerformed|&#x2713;|&#x2713;|&#x2713;|Decimal value|Gets the actual cost of work performed (ACWP) for the assignment to date.|
|ActualOvertimeCost|&#x2713;|&#x2713;|&#x2713;|Decimal value|Gets the actual overtime cost for the assignment.|
|BaselineCost|&#x2713;|&#x2713;|&#x2713;|Decimal value|Gets the total planned costs of the assignment.|
|BaselineCostPerUse|&#x2713;|&#x2713;|&#x2713;|Decimal value|Gets the cost per use of a resource on an assignment, at the time of the project baseline.|
...
|BaselineWorkMilliseconds||&#x2713;|&#x2713;|Decimal value|Gets the total time interval, expressed in milliseconds, of planned person-hours scheduled for an assignment, at the time of the project baseline.|
...
|BudgetedCostWorkPerformed|&#x2713;|&#x2713;|&#x2713;|Decimal value|Gets the budgeted cost of work performed (BCWP).|
|BudgetedCostWorkScheduled|&#x2713;|&#x2713;|&#x2713;|Decimal value|Gets the budgeted cost of work scheduled (BCWS) for the assignment.|
|CostVariance|&#x2713;|&#x2713;|&#x2713;|Decimal value|Gets the cost variance (CV), which is the difference between the baseline cost and the total cost of the assignment.|
...
|FinishVarianceMilliseconds||&#x2713;|&#x2713;|Decimal value|Gets the time interval, expressed in milliseconds, for the variance of the finish date of the assignment.|
...
|LevelingDelayMilliseconds||&#x2713;|&#x2713;|Decimal value|Gets the time interval, expressed in milliseconds, for the amount of time that resource leveling can delay the assignment from its early start date.|
...
|OvertimeCost|&#x2713;|&#x2713;|&#x2713;|Decimal value|Gets the total overtime cost of the assignment.|
|RemainingCost|&#x2713;|&#x2713;|&#x2713;|Decimal value|Gets the total remaining cost of the assignment, as scheduled.|
|RemainingOvertimeCost|&#x2713;|&#x2713;|&#x2713;|Decimal value|Gets the scheduled remaining overtime cost of the assignment.|
|Resume|&#x2713;|&#x2713;|&#x2713;|DateTime|Gets the date and time when a resource resumes work on the assignment.|
|ScheduleCostVariance|&#x2713;|&#x2713;|&#x2713;|Decimal value|Gets the schedule cost variance (CV), which is the difference between the baseline cost and the scheduled cost of the assignment.|
...
|StartVarianceMilliseconds||&#x2713;|&#x2713;|Decimal value|Gets the time interval, expressed in milliseconds, for the variance of the assignment start date.|
...
|WorkVarianceMilliseconds||&#x2713;|&#x2713;|Decimal value|Gets the time interval, expressed in milliseconds, for the difference between baseline work and currently scheduled work on the assignment.|
