...
|BaselineWorkMilliseconds||&#x2713;|&#x2713;|Integer|Gets the total time interval, expressed in milliseconds, of planned person-hours scheduled for an assignment, at the time of the project baseline.|
...
|DelayMilliseconds||&#x2713;|&#x2713;|Integer|Gets the time interval, expressed in milliseconds, for the amount of time that passes after the start date, before work on the assignment starts.|
...
|WorkContourType|&#x2713;|&#x2713;|&#x2713;|[WorkContourType](WorkContourType.md)|Gets the work contour description for the assignment, such as front-loaded, back-loaded, or bell-shaped.|
